...
- [`security-advisories.md`](security-advisories.md) — регистър на advisory-тата от `osv-scanner` в CI: кои са поправени с pnpm override и кои са временно потиснати в `osv-scanner.toml`, с обосновка.
