...
13. ⛨ `settle-windows` - чак след минал гейт: изважда покритието от всички обещания (покритите
    изчезват, частично покритите се свиват, извън обсега остават и се логват)
