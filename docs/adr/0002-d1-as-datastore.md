...
Данните пристигат като **периодични bulk снимки** от ЦАИС ЕОП, не като жива емисия; v1 е
...
Схемата е **един консолидиран файл** ([`0000_init.sql`](../../packages/db/migrations/0000_init.sql)),
а не верига инкрементални миграции — v1 е pre-production и всеки импорт стартира от свежа база;
инкрементални миграции се въвеждат чак когато има деплойнати данни, които не може да се загубят.
