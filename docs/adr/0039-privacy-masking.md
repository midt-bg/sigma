# ADR-0039 — Политика за поверителност на машинно-четим изход (Issue #173)
...
- **Виж също:** [ADR-0040](../adr/0040-centralized-x-robots-tag-worker.md) — инженерното решение за централизирано авторство на `X-Robots-Tag: noindex` в worker-а (рефакторът от PR #183 review) и [`docs/privacy-masking.md`](../privacy-masking.md) за оперативно ръководство.
