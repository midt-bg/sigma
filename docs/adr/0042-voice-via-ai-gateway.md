# ADR-0042 — Voice lane през AI Gateway (provider endpoints, без dynamic routes)
...
- **DoW/rate защита не идва оттук** ([0038](0038-global-bggpt-cap-is-a-durable-object.md) — DO); wallet
...
заявките (иначе гаранцията пада); и DoW cap ([0038](0038-global-bggpt-cap-is-a-durable-object.md) — DO)
