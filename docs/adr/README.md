...
| [0016](0016-free-text-entity-resolution.md) | Разрешаване на субекти от свободен текст (деклариран ЕИК + извличане от проза) | Прието · изменено от [ADR-0046](0046-company-is-its-eik-register-confirms.md) |
...
| [0026](0026-person-grain-name-institution.md) | Идентичност на лицето: (име, ведомство), не голо име — без сливане на съименници, стабилно за E11 divestment | Прието · изменено от [ADR-0040](0040-official-institution-from-the-declaration.md) |
...
| [0032](0032-family-ownership-published-under-public-interest.md) | Дял на свързано лице се публикува на поименната повърхност наравно със собствения — на основание надделяващ обществен интерес (ЗДОИ чл. 41и; C-184/20 забранява само поименните данни); близкият никога не се назовава, връзката не се твърди; заменя ADR-0030 | Прието · изменено от [ADR-0044](0044-relatives-named-when-the-register-confirms-them.md) |
| [0033](0033-registry-evidence-replaces-name-distinctiveness.md) | Връзка се публикува само срещу проверим факт от Търговския регистър — доказателственият ред заменя нивата по отличителност на името; евристиката вече обосновава твърдение (изрично изключение от ADR-0007), барът за акционерни форми е обединение от три сигнала, монотонността е гейт, не хранилище; заменя ADR-0009/0015/0017 | Прието (дизайн) · изменено от [ADR-0041](0041-registry-layer-in-the-daily-etl.md) и [ADR-0046](0046-company-is-its-eik-register-confirms.md) |
| [0034](0034-registry-lookups-and-decisions-share-one-monthly-run.md) | Справките в ТР и решенията текат в едно задание — суровите актове не преживяват изпълнителя, а решението не може да се вземе без тях; заменя твърдението за каденцията в ADR-0033 | Заменено от [ADR-0041](0041-registry-layer-in-the-daily-etl.md) |
| [0035](0035-registry-evidence-must-also-establish-the-company.md) | Стъпало 2 („Документ") публикува само ако извън фирменото наименование нещо установи, че дружеството е декларираното — деклариран ЕИК, съвпадащо седалище или отличителна фирма; иначе `document_uncorroborated`, което се брои; заменя твърдението в ADR-0033, че стъпало 2 не е гейтнато | Заменено от [ADR-0046](0046-company-is-its-eik-register-confirms.md) |
| [0036](0036-tr-rate-limit-remeasured.md) | Ограничителят на ТР, премерен наново: 5 заявки на прозорец, блок по IP, ~161 s изстиване — 429 става изстиване с продължаване, не спиране на хода; заменя контекст 4 и хигиената на решение 7 на [ADR-0033](0033-registry-evidence-replaces-name-distinctiveness.md) | Заменено от [ADR-0041](0041-registry-layer-in-the-daily-etl.md) |
| [0037](0037-verdict-cache-crosses-the-run-boundary.md) | Обхождането издава присъди по (връзка, ЕИК), а не актове: булевите присъди се кешират между ходовете, суровият акт се изтрива веднага, гейтът за покритие става постепенен и монотонността поема защитата; заменя „всеки ход, който решава, трябва и да обхожда" от [ADR-0034](0034-registry-lookups-and-decisions-share-one-monthly-run.md) | Прието · изменено от [ADR-0041](0041-registry-layer-in-the-daily-etl.md) |
| [0038](0038-reseed-writes-idle-slot-gates-read-live.md) | Презасяването пише в празния слот, а гейтовете (монотонност, под за връзки, хидратация на ЕОП) четат живия — разделя „източник за четене" от „цел за запис"; разширява ADR-0005 | Заменено от [ADR-0045](0045-declarations-in-a-cloudflare-container.md) |
| [0039](0039-natural-persons-from-the-trade-register.md) | Физически лица от Търговския регистър са възли в графа на връзките: ролите по дружественото право при дружества със спечелена поръчка, с история; действителни собственици — при съвпадение с вписан съдружник; идентификаторът от API-то не се пази като ключ; заменя отчасти ADR-0007 т. 1 и ADR-0010 т. 5 | Прието |
| [0040](0040-official-institution-from-the-declaration.md) | Ведомството на длъжностното лице идва от самата декларация, когато листингът назовава само вида декларация; изписванията на едно ведомство се сгъват за ключа; старите адреси пренасочват с 301; заменя ключа от [ADR-0026](0026-person-grain-name-institution.md) | Прието |
| [0041](0041-registry-layer-in-the-daily-etl.md) | Слоят „регистър": ролите при изпълнителите — управители, съдружници, органи, действителни собственици — се четат от API-то на Търговския регистър в дневния ETL (Workflow `sigma-registry`), по промените на деня и с дочитане на новите победители; лицето се разпознава по идентификатора на регистъра; доказателственият ред за свързаните лица чете фактите от слоя вместо от свои справки | Прието |
| [0042](0042-declarant-identifier-as-identity-evidence.md) | Идентификаторът на декларатора от регистъра на декларациите е доказателство за идентичност: свързва документите на едно лице през ведомства и години, при съгласувани имена; карантината при два регистрови идентификатора остава решаваща | Прието |
| [0043](0043-registry-person-identifier-across-the-site.md) | Личният идентификатор от Търговския регистър като ключ на лицето в целия сайт: един адрес на лице, група „роля по регистъра“ в списъка, означение „длъжностно лице“ при ролите, разминаване регистър срещу декларация, партиди по име | Прието |
| [0044](0044-relatives-named-when-the-register-confirms-them.md) | Близък с деклариран дял се назовава и се свързва в двете посоки само когато Търговският регистър го вписва в декларираното дружество; изменя решение 2 на ADR-0032 | Прието · изменено от [ADR-0046](0046-company-is-its-eik-register-confirms.md) |
| [0045](0045-declarations-in-a-cloudflare-container.md) | Декларациите се обработват в контейнер в Cloudflare, стартиран от седмичния cron на etl worker-а; GitHub само деплойва кода; публикуването в D1 е атомарна размяна на таблици с предишно поколение за връщане назад; заменя ADR-0038 и рамката „задание в GitHub Actions“ на ADR-0034 | Прието |
| [0046](0046-company-is-its-eik-register-confirms.md) | Дружеството е неговият ЕИК — деклариран или този, до който води наименованието (и по стъбло); връзката се потвърждава само от вписаните в Търговския регистър лица, по всяко време и с варианти на имената, а дял на близък — от вписания близък; седалището не е доказателство; заменя ADR-0035 | Прието |
