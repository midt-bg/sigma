...
| [0044](0044-relatives-named-when-the-register-confirms-them.md) | Близък с деклариран дял се назовава и се свързва в двете посоки само когато Търговският регистър го вписва в декларираното дружество; изменя решение 2 на ADR-0032 | Прието |
