...
4. **Първото публикуване с правила `tr-rules-7`** ([ADR-0042](adr/0042-declarant-identifier-as-identity-evidence.md))
   слива лица и мести всички документи между тях. Размяната на таблици го прави като всяко друго
