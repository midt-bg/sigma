...
> [deploy.yml](../.github/workflows/deploy.yml) прилага изрично `0003`, `0006` и `0007` с
...
> са безопасни за повторно прилагане: `CREATE … IF NOT EXISTS` и, при `0007`, тригери и индекси, които
