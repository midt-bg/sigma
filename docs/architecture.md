...
идентификатори в машинно-четим изход (0033)](adr/0033-privacy-masking.md) и
[централизирано авторство на `X-Robots-Tag: noindex` в worker-а (0034)](adr/0034-centralized-x-robots-tag-worker.md).
