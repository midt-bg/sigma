    ...
    <>
      ...
      >
            ...
            <label>
              ...
              <select name="basis" value={filterValue('basis')} onChange={applyFilters}>
                ...
                {hasDeclarations && (
                  <>
                    <option value="tied">
                      На длъжност и свързан с дружеството{optionCount('basis', 'tied')}
                    </option>
                    <option value="untied">
                      Извън съвпадението{optionCount('basis', 'untied')}
                    </option>
                  </>
                )}
        ...
        <p className="small muted profile-period-note">
          ...
          {hasDeclarations &&
            'Съвпадението иска едновременно две неща: ролята на лицето в същото дружество да е вписана към датата на подписване и лицето да заема публична длъжност тогава. Длъжността се знае по година, а началото и краят ѝ — по датите на встъпителната и финалната декларация, когато ги има. '}
