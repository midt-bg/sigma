...
const CHIP_HELP: Record<string, string> = {
  ...
  'само по търговския регистър':
    'Лицето няма публикуван деклариран дял в това дружество; показва се, защото регистърът го вписва в него. Вписването само по себе си не е деклариран интерес и не е нарушение.',
  'не е посочено в декларация':
    'Регистърът вписва дружеството за лицето, а годишната декларация за съответната година не го назовава. Разминаването се показва както е — то не доказва нито пропуск, нито укриване.',
};
