          ...
          <div>
            ...
            <section className="section" aria-labelledby="flagged">
              ...
              <p>
                ...
                които поне един структурен признак заслужава преглед. Сигналите са{' '}
                <em>ориентири</em>, не присъда: те не твърдят нарушение, а насочват към договори,
                които си струва да се погледнат. Всяко число води до самите договори.
              </p>
              <p>
                Отбелязваме четири признака, същите, които се виждат и на страницата на всеки
                договор:
              </p>
              <dl className="glossary">
                ...
                <dd>
                  <p>
                    Допусната е една-единствена оферта (приети оферти = 1). Отделяме случаите със
                    средства от ЕС, където правилата за конкуренция са по-строги.
                  </p>
                ...
                <dd>
                  <p>
                    Стойност с непотвърдена достоверност (виж речника) или договор, подписан преди
                    датата си на публикуване.
                  </p>
                  <span className="src">→ value_flag / date_flag</span>
                </dd>
              </dl>
              <Callout>
                <h2>Как се смята сумата</h2>
                <p className="m-0">
                  ...
                  сектор и по тип институция разделят множеството и се сумират до общата сума.
                  Стойностите стъпват на каноничната изчистена стойност в евро (сумираме само
                  договорите с достоверна стойност — договор с непотвърдена стойност се брои в
                  бройката, но с 0 €).
                </p>
              </Callout>
            </section>
