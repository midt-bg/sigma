          ...
          <div>
            <section className="section" aria-labelledby="what">
              ...
              <p>
                ...
                процедурите. Показва неутрални индикатори, обобщени от самите договори — те не са
                обвинение и не установяват нарушение.
              </p>
            ...
            <section className="section" aria-labelledby="glossary">
              ...
              <dl className="glossary">
                ...
                <dt id="risk">Обобщен рисков индикатор</dt>
                <dd>
                  <p>
                  ...
                  <p>
                    ...
                    признака; за физически лица не се показва. Категорията („Малко" → „Много
                    индикатори") е неутрална и описва индикаторите, не субекта; праговете са
                    временни и подлежат на калибриране. „Високо оскъпяване" не включва анексите с
                    подозрителни стойности, затова е консервативна долна оценка.
                  </p>
                  <span className="src">→ scripts/precompute.sql · bids_received = 1</span>
                </dd>
