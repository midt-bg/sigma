          ...
          <div>
            ...
            <section className="section" aria-labelledby="money">
              ...
              <p>
                ...
                Показваме я само при поне 12 такива договора; позицията е приблизителна (широки
                стъпала, не точен процент) и е контекст за мащаба, а не оценка за нередност.
                Договори с непотвърдена стойност не участват и не получават сравнение.
              </p>
            </section>
