        ...
        <div className="split">
          ...
          <div>
            <section className="section" aria-labelledby="what">
              ...
              <p>
                СИГМА е изцяло само за четене: не въвежда нови данни и не маркира фирми като
                рискови. Автоматичните ценови сигнали (виж раздел „Аномалии и сигнали“) са
                детерминистични проверки върху отделни договори, не оценки на фирми или
                институции.
              </p>
            ...
            <section className="section" aria-labelledby="gaps">
              ...
              <p className="small muted" style={{ marginTop: 'var(--s-3)' }}>
                <strong>Място на изпълнение</strong> и <strong>собственици и свързани лица</strong> са в
                процес на разработка за следваща версия — изискват пълно сливане с допълнителни
                източници. Първите <strong>автоматични ценови сигнали</strong> вече са налични — виж
                следващия раздел.
              </p>
            </section>

            <section className="section" aria-labelledby="flags">
              <h2 id="flags">9. Аномалии и сигнали</h2>
              <p className="section-hint">
                Страницата <Link to="/anomalies">Аномалии</Link> показва договори, при които
                детерминистична проверка върху числата от регистъра е дала сигнал.
                Сигналът е <strong>индикатор за проверка, не присъда</strong> — висока стойност може
                да има напълно легитимно обяснение (по-голям обем, опции, индексация).
              </p>
              <p>Три ценови сигнала поставят договор в списъка:</p>
              <ul>
                <li>
                  <strong>Над прогнозата</strong> — стойността при подписване е с ≥ 10% над
                  прогнозната стойност, обявена от самия възложител. Сравняваме само когато
                  прогнозата покрива точно този договор: прогноза на обособената позиция за
                  договори по лот, прогноза на поръчката за поръчки без лотове. Рамкови
                  споразумения и динамични системи (повече договори, отколкото лотове — там
                  прогнозата е общ таван) се изключват, както и прогнози под 1 хил. € и договори
                  под 10 хил. €.
                </li>
                <li>
                  <strong>Ръст чрез анекси</strong> — текущата стойност след изменения е с ≥ 20% над
                  стойността при подписване. ЗОП чл. 116 ограничава повечето изменения до
                  10–50%, затова ръст ≥ 50% носи по-висока тежест.
                </li>
                <li>
                  <strong>Далеч над типичното</strong> — стойността е ≥ 5 пъти над медианата на
                  договорите със същия пълен CPV код (при ≥ 10 такива договора и стойност ≥ 50
                  хил. €). Това е най-мекият сигнал: по-голяма поръчка не значи по-лоша цена,
                  затова показваме медианата и броя съпоставими договори до всяко число.
                  Медианата се изчислява върху всички съпоставими договори, включително самия
                  договор — при праг от ≥ 10 съпоставими ефектът е пренебрежим.
                </li>
              </ul>
              <p>
                Два контекстни сигнала — <strong>единствена оферта</strong> в състезателна
                процедура и възлагане <strong>без обявление</strong> — добавят точки към риска, но
                сами по себе си не поставят договор в списъка. Рискът (0–100) е претеглен сбор:
                над прогнозата 25/35/45 т. (≥ 1,1× / 1,5× / 3×), анекси 20/30 т. (≥ 1,2× / 1,5×),
                над типичното 15/25 т. (≥ 5× / 10×), единствена оферта 10 т., без обявление 5 т.
              </p>
              <Callout title="Ограничения">
                <p style={{ margin: 0 }}>
                  Проверките работят само с числата, публикувани в регистъра — не виждат
                  количества, единични цени или качество на изпълнението. Договори със съмнителни
                  стойности в източника („данните се проверяват“) са изключени от проверките
                  изцяло. Медианите по CPV код се преизчисляват при пълно презареждане на данните,
                  не в реално време: дневното обновяване преизчислява сигналите само за променените
                  договори спрямо последните изчислени медиани, а съвсем нова група съпоставими
                  договори започва да дава сигнал при следващото пълно презареждане. Праговете и
                  кодът на проверките са публични в хранилището на проекта.
                </p>
              </Callout>
            </section>
