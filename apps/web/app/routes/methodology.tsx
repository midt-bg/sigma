              ...
              <dl className="glossary">
                ...
                <dd>
                  <p>
                    ...
                    класифицирана процедура (открита/състезание/събиране на оферти или пряко); неутралните
                    („договаряне с покана", „друго") и синтетичните процедури с неизвестен вид се отчитат
                    отделно и не влизат в дела. Неутрален индикатор за слаба конкуренция, не оценка на
                    процедурата.
                  </p>
                ...
                <dd>
                  <p>
                    ...
                    използва два от тях само като <strong>външен ориентир</strong>: дял с една оферта —
                    целево ≤ 10%, високо &gt; 20%; дял пряко възлагане — целево ≤ 5%, високо ≥ 10%.
                    Това е сравнение спрямо обща рамка, а не оценка на конкретна процедура или възложител.
                  </p>
                  <span className="src">
                    →{' '}
                    <a
