  ...
  return (
    <>
      ...
      <main id="main">
        ...
        <section className="section" aria-labelledby="derived">
          <h2 id="derived">Производни показатели (сигнали за риск)</h2>
          <p>
            Освен публикуваните полета СИГМА изчислява <strong>структурни сигнали за риск</strong>{' '}
            върху вече публичните данни — например липса на конкуренция, ръст на стойността чрез
            анекси или стойностна/времева аномалия — и показва обобщена стойност на договорите с
            поне един такъв сигнал.
          </p>
          <p>
            Тези сигнали са <em>ориентири за преглед, а не констатация за нарушение</em>, и не
            оценяват поведението на конкретно лице. Логиката е публична и възпроизводима — виж{' '}
            <a href="/methodology#flagged">методологията</a>. Обработването се основава на същите
            правни основания по-горе (чл. 6, пар. 1, букви (e) и (f) от GDPR) и не създава нови
            категории лични данни. Ако смятате конкретен сигнал за неточен, важат правото на
            коригиране (чл. 16) и на възражение (чл. 21) — вижте по-долу.
          </p>
        </section>
