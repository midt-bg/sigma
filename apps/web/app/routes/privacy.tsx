      ...
      <main id="main">
        ...
        <section className="section" aria-labelledby="natural-person-data">
          ...
          <p>
            ...
            <code>/authorities.csv</code>. В <strong>JSON и CSV износите</strong> ЕИК и
            оригиналното име от източника (raw source name) на физическото лице се заменят с
            неутрален, неидентифициращ етикет, а полето за ЕИК остава празно. В{' '}
            <strong>близнака <code>/companies/:eik.data</code></strong> — който е React Router v7
            single-fetch transport за client-side навигация (презарежда същата HTML страница от
            същите данни) — се прилага само noindex и нулиране на ЕИК; името на търговското дружество
            остава видимо, защото HTML страницата, която този близнак захранва, умишлено го показва
            (ADR-0039 §6). Записите за юридически лица не се променят — техните ЕИК и имена
            остават непокътнати.
          </p>
          <p>
