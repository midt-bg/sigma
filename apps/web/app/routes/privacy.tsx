      ...
      <main id="main">
        ...
        <section className="section" aria-labelledby="data">
          ...
          <p>
            ...
            субектите; приложим е редът за уведомяване по чл. 14 от GDPR.
          </p>
        </section>
        ...
        <section className="section" aria-labelledby="rights">
          ...
          <p>
            При установена неточност в изходните данни от ТРРЮЛНЦ уведомяваме Агенцията по
            вписванията. Вижте и{' '}
            <Link to="/conflicts/methodology#contest">реда за поправки и оспорване</Link>.
          </p>
        </section>
