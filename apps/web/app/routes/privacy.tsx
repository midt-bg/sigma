      ...
      <main id="main">
        ...
        <section className="section" aria-labelledby="natural-person-data">
          ...
          <p>
            ...
            прилагаме допълнителна защита в машинно-четливите формати. Отговорите се предават с
            HTTP заглавието <code>X-Robots-Tag: noindex</code>, за да не попадат в индексите на
            търсачките и останалите автоматични роботи.
          </p>
          <p>
            Засегнати са следните машинно-четливи формати: JSON записът на отделен договор
            (<code>/contracts/:id.json</code>) и трите публични CSV износа —{' '}
            <code>/contracts.csv</code>, <code>/companies.csv</code> и{' '}
          ...
          <p>
            ...
            първичния източник. Единствената допълнителна мярка е мета-етикетът{' '}
            <code>noindex</code>, който препоръчва на търсачките да не индексират страницата. Така
            публичният достъп за хората се запазва, а публичното откриване чрез търсене — не.
          </p>
          <p>
