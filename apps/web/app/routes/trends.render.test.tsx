...
// empty-list and legacy-`g`-param canonicalisation cases — the loader itself is covered by the
// vi.mock-backed tests in trends.test.ts.
...
describe('/trends page render', () => {
  ...
  it('renders a CPV filter chip', () => {
    render('/trends?cpv=45233', loaderData({ cpv: '45233' }));
