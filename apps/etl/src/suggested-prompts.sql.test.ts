...
// (0000_init + 0011_assistant_prompts) with a deterministic fixture and asserts the numbers each slot
...
const migration1 = resolve(root, 'packages/db/migrations/0011_assistant_prompts.sql');
