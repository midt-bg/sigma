...
// precompute writes the subject-risk columns (#229), which live in 0014 — only the backfill test
// below runs precompute, so 0014 is applied there and nowhere else in this file.
