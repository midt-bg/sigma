...
const GOLDEN = {
  ...
  contracts: [
    { id: `c:e:UNP-G1:CN-1:_:${B1}:1`, bidder_id: B1, amount_eur: 100000, value_flag: 'ok', signing_value_eur: 100000, current_value_eur: null, fx_converted: 0, fx_rate: null, annex_count: 0 },
    { id: `c:e:UNP-G2:CN-2:_:${B2}:1`, bidder_id: B2, amount_eur: 50000, value_flag: 'ok', signing_value_eur: 50000, current_value_eur: null, fx_converted: 0, fx_rate: null, annex_count: 0 },
    { id: `c:e:UNP-G3:CN-3:_:${B1}:1`, bidder_id: B1, amount_eur: 45000, value_flag: 'ok', signing_value_eur: 45000, current_value_eur: null, fx_converted: 1, fx_rate: 0.9, annex_count: 0 },
    { id: `c:e:UNP-G4:CN-4:_:${B3}:1`, bidder_id: B3, amount_eur: 1000, value_flag: 'value_suspect', signing_value_eur: null, current_value_eur: null, fx_converted: 0, fx_rate: null, annex_count: 0 },
    { id: `c:e:UNP-G5:CN-5:_:${B1}:1`, bidder_id: B1, amount_eur: 15000, value_flag: 'review', signing_value_eur: 15000, current_value_eur: null, fx_converted: 0, fx_rate: null, annex_count: 0 },
    { id: `c:e:UNP-G6:CN-6:_:${B2}:1`, bidder_id: B2, amount_eur: 100, value_flag: 'annex_suspect', signing_value_eur: 100, current_value_eur: null, fx_converted: 0, fx_rate: null, annex_count: 1 },
    { id: `c:e:UNP-G7:CN-7:_:${B1}:1`, bidder_id: B1, amount_eur: 0, value_flag: 'value_low', signing_value_eur: 0, current_value_eur: null, fx_converted: 0, fx_rate: null, annex_count: 0 },
    { id: `c:e:UNP-G8:CN-8:_:${B2}:1`, bidder_id: B2, amount_eur: 30000, value_flag: 'ok', signing_value_eur: 20000, current_value_eur: 30000, fx_converted: 0, fx_rate: null, annex_count: 1 },
  ],
  ...
  companyTotals: [
    { bidder_id: B1, name: 'Голдън Строй ЕООД', kind: 'company', ownership_kind: null, eik: '111111111', eik_valid: 1, won_eur: 160000, contracts: 4, authorities: 2, primary_sector: '45', eu_eur: 0, first_date: '2026-06-01', last_date: '2026-06-07' },
    { bidder_id: B2, name: 'Български пощи ЕАД', kind: 'company', ownership_kind: 'state', eik: '121396123', eik_valid: 1, won_eur: 80100, contracts: 3, authorities: 2, primary_sector: '45', eu_eur: 50000, first_date: '2026-06-02', last_date: '2026-06-08' },
    { bidder_id: B3, name: 'SECRET WINNER LTD', kind: 'company', ownership_kind: null, eik: null, eik_valid: 0, won_eur: 1000, contracts: 1, authorities: 1, primary_sector: '33', eu_eur: 0, first_date: '2026-06-04', last_date: '2026-06-04' },
  ],
  ...
  authorityTotals: [
    { authority_id: A1, name: 'Министерство на тестовата инфраструктура', type_group: 'министерство', settlement: 'София', region: 'София (столица)', spent_eur: 150100, contracts: 4, suppliers: 2, avg_eur: 37525, primary_sector: '45', eu_eur: 50000, first_date: '2026-06-01', last_date: '2026-06-07' },
    { authority_id: A2, name: 'Община Голдънво', type_group: 'община', settlement: null, region: null, spent_eur: 91000, contracts: 4, suppliers: 3, avg_eur: 22750, primary_sector: '33', eu_eur: 0, first_date: '2026-06-03', last_date: '2026-06-08' },
  ],
  ...
  homeTotals: { contracts: 8, value_eur: 241100, authorities: 2, bidders: 3, suspect: 1, first_date: '2026-06-01', last_date: '2026-06-08', as_of: '2026-06-08' },
