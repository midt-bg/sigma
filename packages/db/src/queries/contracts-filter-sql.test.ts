...
INSERT INTO contracts (id, tender_id, bidder_id, amount, currency, signed_at, bids_received, value_flag, amount_eur, is_high_markup) VALUES
  ('c:NULL', 't:A', 'eik:200000002', 100, 'EUR', '2024-01-01', NULL, 'ok', 100, NULL),
  ('c:ZERO', 't:A', 'eik:200000002', 200, 'EUR', '2024-01-02', 0,    'ok', 200, 0),
  ('c:ONE',  't:A', 'eik:200000002', 300, 'EUR', '2024-01-03', 1,    'ok', 300, 0),
  ('c:TWO',  't:A', 'eik:200000002', 400, 'EUR', '2024-01-04', 2,    'ok', 400, 1);
`;
