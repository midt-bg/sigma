...
-- signal in contract_anomalies; rebuilt on full import (precompute.sql), kept as-is by the daily slice.
CREATE TABLE cpv_price_stats (
...
CREATE INDEX idx_anomalies_rank ON contract_anomalies(rank_value DESC);
CREATE INDEX idx_anomalies_amount ON contract_anomalies(amount_eur);
CREATE INDEX idx_anomalies_signed ON contract_anomalies(signed_at);
CREATE INDEX idx_anomalies_authority ON contract_anomalies(authority_id);
CREATE INDEX idx_anomalies_bidder ON contract_anomalies(bidder_id);
